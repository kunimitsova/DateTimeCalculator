...
/**
 * Lifted from the androidx.compose.material3 library
 * because I want this functionality but material3 is still in alpha.
 * The only changes from the original are commenting out the annotations
 * @ExperimentalMaterial3WindowSizeClassApi and
 * @TestOnly
 */
