...
/**
 * Lifted from androidx.compose.material3.windowsizeclass
 * Because I want to use this functionality but material3 is
 * in alpha rn. the only change is commented out
